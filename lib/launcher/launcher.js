...
var Launcher = appolo.EventDispatcher.define({
    ...
    launch: function (config) {
        ...
        this._options = _.extend(config || {}, defaults);
        ...
        //load files
        appolo.loader.loadFiles(['config', 'server'], this._options.root,this.cachedRequire);

        //load env files
        appolo.loader.loadFiles(appolo.environment.paths, this._options.root,this.cachedRequire);
    ...
    _loadRoutes: function () {
        ...
        fs.readdirSync(routesPath).forEach(function (file) {
            ...
            var routePath = path.join(this._options.root, 'config', 'routes', file);
            this.cachedRequire.push(routePath);
