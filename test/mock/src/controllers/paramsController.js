...
tslib_1.__decorate([
    (0, route_1.get)('/test/params/:name/:name2'),
    (0, route_1.patch)('/test/params/:name/:name2'),
    (0, route_1.put)('/test/params/:name/:name2'),
    (0, route_1.get)('/test/params/:name/test/:name2'),
    tslib_1.__param(2, (0, route_1.model)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, Object]),
    tslib_1.__metadata("design:returntype", void 0)
], ParamsController.prototype, "test", null);
tslib_1.__decorate([
    (0, route_1.get)('/test/params/empty/:name/:name2'),
    (0, route_1.del)('/test/params/empty/:name/:name2'),
    tslib_1.__metadata("design:type", Function),
